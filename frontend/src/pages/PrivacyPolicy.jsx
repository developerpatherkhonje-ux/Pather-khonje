        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              At Pather Khonje, we are committed to protecting your privacy and
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            ...
            >
              ...
              <p className="text-gray-700">
                We retain your personal information only for to fulfill the
                purposes outlined in this privacy policy, comply with legal
                obligations, resolve disputes, and enforce our agreements.
                Travel-related information may be retained for up to 7 years for
            ...
            >
              ...
              <div className="space-y-2 text-gray-700">
                <p>
                  <strong>Email:</strong> privacy@patherkhonje.com
                </p>
                <p>
                  <strong>Phone:</strong> +91 7439857694
                </p>
                <p>
                  <strong>Address:</strong> 64/2/12, Biren Roy Road (East),
