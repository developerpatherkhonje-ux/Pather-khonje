...
module.exports = {
  ...
  MONGODB_URI:
    process.env.MONGODB_URI || "mongodb://localhost:27017/pather-khonje",
  ...
  JWT_REFRESH_SECRET:
    process.env.JWT_REFRESH_SECRET || "your-refresh-token-secret-key-here",
  ...
  PROPRIETOR_EMAIL:
    process.env.PROPRIETOR_EMAIL || "somashah.mitra@patherkhonje.com",
